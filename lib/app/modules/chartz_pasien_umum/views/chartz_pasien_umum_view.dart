...
class ChartzPasienUmumView extends GetView<ChartzPasienUmumController> {
  const ChartzPasienUmumView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 1,
        title: const Text('Grafik Pasien Umum'),
        centerTitle: false,
      ),
      body: AspectRatio(
        aspectRatio: 1,
